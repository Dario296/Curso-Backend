...
// productos.save({title:'titulo4', price:50, thumbnail: 'titulo4'})
// productos.save({title:'titulo5', price:70, thumbnail: 'titulo5'})
// productos.getById(1)
// productos.getAll()
...
app.get('/productoRandom', async (req, res) => {
    res.send(await productos.getById(getRandomIntInclusive(1, 5)))
})
